                            ...
                            {this.props.votes.map((song, key) => (
                                ...
                                >
                                    <AlbumArt
                                        ...
                                        art={song.art}
                                        hover="voteSong"
                                        selected={this.state.votedSong === key ? true : false}
                                    />
                                </GridListTile>
                            ))}
                        </GridList>
...
export default connect(mapStateToProps, mapDispatchToProps)(withStyles(styles)(Channel));
